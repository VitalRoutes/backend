...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    @Query("select c from Comment c join fetch c.member where c.participation.participationId = :participationId and c.commentId not in :hideIds order by c.commentId asc")
