...
public class BoardService {
    ...
    public void save(BoardDTO boardDTO) throws IOException, ImageProcessingException, URISyntaxException {
        ...
        if(boardDTO.getTitleImage().isEmpty()){
            ...
            log.info("saved starting position");
